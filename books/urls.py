...
from .views import BookListView,BookDetailView,ReviewUpdateView,DeleteReviewView,BookAuthorView
...
urlpatterns = [
    ...
    path('author/<int:id>',BookAuthorView.as_view(),name='book_author')
]
